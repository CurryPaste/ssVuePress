...
See the Pen [Speed Test: GSAP vs CSS Transitions (Zepto) vs jQuery](http://codepen.io/GreenSock/pen/srfxA/) by GreenSock ([@GreenSock](http://codepen.io/GreenSock)) on[CodePen](http://codepen.io/).
